...
class BamlAsyncClient:
    ...
    async def QueryAudio(self, query: str,audio_files: typing.List[baml_py.Audio],
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            stream = self.stream.QueryAudio(query=query,audio_files=audio_files,
                baml_options=baml_options)
            return await stream.get_final_response()
        else:
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="QueryAudio", args={
                "query": query,"audio_files": audio_files,
            })
...
class BamlStreamClient:
    ...
    def QueryAudio(self, query: str,audio_files: typing.List[baml_py.Audio],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="QueryAudio", args={
            "query": query,"audio_files": audio_files,
        })
...
class BamlHttpRequestClient:
    ...
    async def QueryAudio(self, query: str,audio_files: typing.List[baml_py.Audio],
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="QueryAudio", args={
            "query": query,"audio_files": audio_files,
        }, mode="request")
        return result
