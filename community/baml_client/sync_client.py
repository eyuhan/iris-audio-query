...
class BamlSyncClient:
    ...
    def QueryAudio(self, query: str,audio_files: typing.List[baml_py.Audio],
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="QueryAudio", args={
...
class BamlStreamClient:
    ...
    def QueryAudio(self, query: str,audio_files: typing.List[baml_py.Audio],
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="QueryAudio", args={
            "query": query,"audio_files": audio_files,
        })
...
class BamlHttpRequestClient:
    ...
    def QueryAudio(self, query: str,audio_files: typing.List[baml_py.Audio],
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="QueryAudio", args={
            "query": query,"audio_files": audio_files,
        }, mode="request")
        return result
